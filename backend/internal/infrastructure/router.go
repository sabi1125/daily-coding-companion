...
func RegisteredProblemsRoutes(
	...
	interactor := interactor.NewProblemsInteractor(repository, ingestRunner, ingestRepository, settingRepository, claudeClient)
	...
	problems.GET("/:id/help", controller.GetAIHelp)
}
